...
CLUSTERS = {'SEA_OUTDOOR':SEA_OUTDOOR,'LAND_OUTDOOR':LAND_OUTDOOR,'CASINOS':CASINOS,
'CONCERTS_SHOWS':CONCERTS_SHOWS,'FOOD_DRINK':FOOD_DRINK,'GROUND_NATURE':GROUND_NATURE,'COLD_OUTDOOR':COLD_OUTDOOR
,'MUSEUMS':MUSEUMS,'NATURE_PARKS':NATURE_PARKS,'OUTDOOR_ACTIVITIES':OUTDOOR_ACTIVITIES, 'SHOPPING':SHOPPING,
'SPAS_AND_WELLNESS':SPAS_AND_WELLNESS,'TOURS':TOURS,'AMUSEMENT_PARKS':AMUSEMENT_PARKS,'ZOOS':ZOOS, 'SEA_NATURE':SEA_NATURE,'SIGHTS_AND_LANDMARKS':SIGHTS_AND_LANDMARKS}
